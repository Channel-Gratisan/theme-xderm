...
echo '<div class="nganu slide" style="display: flex; height: 110%; flex-shrink: 0; font-weight: bold; font-size: 90%; font-align: center; ! important; padding-top: 15px"><p style="text-align:center">
        Logo & Mods by <a href="https://me.helmiau.my.id" target="_blank">MasWay</a> • Theme by <a href="https://www.facebook.com/adi.persada.560/" target="_blank">MasWay</a><br>
                Main Developer <a href="https://github.com/ryanfauzi1" target="_blank">MasWat</a> • Copyright &copy 2022
    </div>';
}
if($_POST['button2']){
